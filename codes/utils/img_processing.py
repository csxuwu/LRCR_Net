...
def read_image(filename, is_resize=False,resize_height=None, resize_width=None, normalization=False,
               is_long_resize=False, is_cvtColor=''):
    '''
    ...
    if is_resize:
        rgb_image = resize_image(rgb_image, resize_height, resize_width, is_long_resize=is_long_resize)
    if is_cvtColor == "YCrCb":
...
def resize_image(image, resize_height, resize_width, is_long_resize=False):
    '''
    :param image:
    :param resize_height:
    :param resize_width:
